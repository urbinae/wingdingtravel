	...
	<div id="page">
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url(images/slider/slider-1.jpg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h2>Family comes first</h2>
			   	...
			   	<li style="background-image: url(images/slider/slider-2.jpg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
				   				<div class="slider-text-inner text-center">
				   					...
				   					<h1>Best Tours in the DR!</h1>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
			   	</li>
			   	<li style="background-image: url(images/slider/slider-3.jpg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluids">
			   			<div class="row">
				   			<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h2>The Perfect ride to</h2>
				   					<h1>¡Paradise!</h1>
				   				</div>
				   			</div>
				   		</div>
			   	...
			   	<li style="background-image: url(images/slider/slider-4.jpg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h2>White Sand and Turquoise water,</h2>
				   					<h1>We get in charge of the rest!</h1>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
			   	</li>
			   	<li style="background-image: url(images/slider/slider-5.jpg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h2>Enjoying the Sunset with your</h2>
				   					<h1>friends, Priceless!</h1>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
			   	</li>
			   	<li style="background-image: url(images/slider/slider-6.jpg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h2>Fun for the tiny ones!</h2>
				   					<h1>WingDing Travel</h1>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
			   	</li>
			   	<li style="background-image: url(images/slider/slider-7.jpg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h2>The Warm and Refreshing</h2>
				   					<h1>Caribbean Sea</h1>
				   				</div>
				   			</div>
				   		</div>
		...
		<div class="colorlib-tour colorlib-light-grey" id="excursiones">
			<div class="container">
				<div class="col-md-6 col-md-offset-3 text-center colorlib-heading animate-box" style="margin-bottom: 1em;">
					...
					<p>We provide the highest quality tours and transportation services by performing extensive research, site inspections, and detailed reviews. While other companies also offer excursions, we strongly believe our expertise, passion and enthusiasm on what we do, set us apart.
					</p>
				</div>
				<div class="row">
					<div class="col-md-12">
		...
		<div id="colorlib-intro" class="intro-img" style="background-image: url(images/cover-img-2.jpg);" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
								...
								<div class="text-lefts">
									<div class="sale-box">
										<div class="sale-box-top">
											<h2 class="number">Our</h2>
											<span class="sup-1">%</span>
											<span class="sup-2">Promotion</span>
										</div>
										<h2 class="text-sale">Now</h2>
									</div>
								</div>
								<div class="text-rights">
									<h3 class="title">Saona Island!</h3>
									<p>Just hurry up limited offer!,live a full adventure sharing with yours.</p>
									<p><a href="Tours/Saona-Island/" class="btn btn-primary">Book Now</a> <a href="Tours/Saona-Island/" class="btn btn-primary btn-outline">Read more</a></p>
								</div>
							</div>
						</div>
					</div>
					<div class="col-md-6 animate-box">
						<div class="video-wrap">
							<div class="video colorlib-video" style="background-image: url(images/tours/tour-7.jpg);">
		...
		<div id="colorlib-subscribe" data-stellar-background-ratio="0.5" style="display: none;">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
		...
		<div id="colorlib-contact" style="background: #fafafa;">
			<div class="container">
				<div class="row">
					<div class="col-md-10 col-md-offset-1 animate-box fadeInUp animated-fast">
						<h3>Get In Touch</h3>
						<form action="controller/contactar.php" method="post">
							<div class="row form-group">
								<div class="col-md-6 padding-bottom">
									<label for="nameC">First Name</label>
									<input type="text" name="nameC" id="nameC" class="form-control" placeholder="Your firstname" required>
								</div>
								<div class="col-md-6">
									<label for="lastnameC">Last Name</label>
									<input type="text" name="lastnameC" id="lastnameC" class="form-control" placeholder="Your lastname" required>
								</div>
							</div>
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<input type="text" name="emailC" id="emailC" class="form-control" placeholder="Your email address" required>
								</div>
							</div>
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<input type="text" name="subjectC" id="subjectC" class="form-control" placeholder="Your subject of this message" required>
								</div>
							</div>
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<textarea name="messageC" id="messageC" cols="30" rows="10" class="form-control" placeholder="Say something about us" required></textarea>
								</div>
							</div>
							<div class="g-recaptcha" data-sitekey="6LeLYVoUAAAAAJegsdBh31nHgaJ3ji_x5tUVGPMX"></div>
		...
		<footer id="colorlib-footer" role="contentinfo" style="padding-bottom: 0;">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12 text-center">
						...
						<p style="color: #0e0e0e;margin-bottom: 0;">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
		    ...
		    <form name="onewayform" id="onewayform">
		        ...
		        <input type="hidden" class="form-control" name="fechaOW" id="fechaOW" value="<?php echo date('m/d/Y'); ?>" readonly><br>
		        <input type="hidden" class="form-control" name="idOW" id="idOW" readonly>
	            ...
	            <input type="text" class="form-control" name="telefonoOW" id="telefonoOW" placeholder="Phone">
	            <h2 style="text-align: center;display: none;">Billing Data</h2>
	            <input type="hidden" class="form-control" name="servicioOW" id="servicioOW" readonly>
	            <input type="hidden" class="form-control" name="desdeOW" id="desdeOW" readonly>
	            <input type="hidden" class="form-control" name="hastaOW" id="hastaOW" readonly>
	            <input type="hidden" class="form-control" name="adultosOW" id="adultosOW" readonly>
	            <input type="hidden" class="form-control" name="ninosOW" id="ninosOW" readonly><br>
	            ...
	            <h2 style="text-align: center;display: none;">Additional</h2>
	            <label style="display: none;">Seat Child</label>
	            <input type="hidden" class="form-control" name="asientoninoOW" id="asientoninoOW" readonly>
	            <label style="display: none;">Beer</label>
	            <input type="hidden" class="form-control" name="cervezaOW" id="cervezaOW" readonly>
	            <label style="display: none;">Water</label>
	            <input type="hidden" class="form-control" name="aguaOW" id="aguaOW" readonly>
	            <label style="display: none;">Soda</label>
	            <input type="hidden" class="form-control" name="sodaOW" id="sodaOW" readonly><br>
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
		    ...
		    <form name="roundtripform" id="roundtripform">
		        ...
		        <input type="hidden" class="form-control" name="fechaRT" id="fechaRT" value="<?php echo date('m/d/Y'); ?>" readonly><br>
		        <input type="hidden" class="form-control" name="idRT" id="idRT" readonly>
	            ...
	            <h2 style="text-align: center;display: none;">Billing Data</h2>
	            <input type="hidden" class="form-control" name="servicioRT" id="servicioRT" readonly>
	            <input type="hidden" class="form-control" name="desdeRT" id="desdeRT" readonly>
	            <input type="hidden" class="form-control" name="hastaRT" id="hastaRT" readonly>
	            <input type="hidden" class="form-control" name="adultosRT" id="adultosRT" readonly>
	            <input type="hidden" class="form-control" name="ninosRT" id="ninosRT" readonly>
	            <label>Infants</label><br>
	            ...
	            <h2 style="text-align: center;display: none;">Additional</h2>
	            <label style="display: none;">Seat Child</label>
	            <input type="hidden" class="form-control" name="asientoninoRT" id="asientoninoRT" readonly>
	            <label style="display: none;">Beer</label>
	            <input type="hidden" class="form-control" name="cervezaRT" id="cervezaRT" readonly>
	            <label style="display: none;">Water</label>
	            <input type="hidden" class="form-control" name="aguaRT" id="aguaRT" readonly>
	            <label style="display: none;">Soda</label>
	            <input type="hidden" class="form-control" name="sodaRT" id="sodaRT" readonly><br>
