  ...
  <!-- Facebook and Twitter integration -->
		...
		<nav class="colorlib-nav" role="navigation" style="background: #2d2f3f;">
			<div class="top-menu">
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-2">
							<div id="colorlib-logo"><a href="../../">Media Luna</a></div>
						</div>
											...
											<div class="room-wrap">
												<div class="row">
													<div class="col-md-12 col-sm-12">
														<div class="desc">
															<h2>Description</h2>
															<p>A day full of excitement where you will live an unforgettable experience with four different activities in the same tour: Safari, Catamaran, Beach, Snorkel, an incomparable combination for your vacations.</p>
															<p><a href="#formulariocompratour" class="btn btn-primary">BOOK NOW!</a></p>
															<p>Enjoy the fabulous view from the Top of Montaña Redonda and the Sea to the maximum with this excursion in which you will get to know the coast of Miches, the new tourist destination of the Dominican Republic.</p>
															<p>Let’s go on a Safari to the famous Montaña Redonda where you can see the best 360 ° panoramic view that will make you feel full of excitement.</p>
															<p>To continue the day, enjoy aboard of a catamaran where we will visit one of the best beaches in the Eastern part of the Dominican Republic. Do some snorkeling in the beautiful reef formations and discover the wonders of the underwater world.</p>
															...
															<p>
																...
																- Activity/tour voucher <br>
															</p>
															<h3>THINGS TO TAKE ON THE TOUR:</h3>
															<p>
																- Round trip transportation (Bus, Boat & Safari Truck)<br>
																- Professional guide <br>
																- Brekfast, Lunch and open bar
															</p>
															<h3>NEVER FORGET:</h3>
															<p>
															...
															<p style="color: red;">
																<strong>
																	- OPERATION DAYS: THURSDAYS & SATURDAYS ONLY<br>
																	- PICK-UP FROM HOTELS: FROM 7:00 TO 8:15AM (DEPENDING ON YOUR HOTEL LOCATION). <br>
																	- DURATION: FULL DAY ( 7 HOURS APPROX.)
																</strong>
															</p>
															<p style="color: red;">
																<strong>
					                ...
					                <div class="col-md-12">
					                  <div class="form-group">
					                    <div class="form-field">
					                      ...
					                      <input type="text" name="tourRecogidadelhotel" id="tourRecogidadelhotel" class="form-control" readonly value="7:00AM to 8:15AM">
					                    </div>
					                  </div>
					                </div>
					                <div class="col-md-12">
	...
	<script>
		$(document).ready(function(){
			$("#tourFecha").datepicker({ startDate: "+0d", daysOfWeekDisabled: [0,1,2,3,5] });
		});
	    ...
	    if (document.getElementById('tourHotel1').value != "") {
	      ...
	      document.getElementById('tournombre').value = 'Media Luna';
