  ...
  <!-- Facebook and Twitter integration -->
		...
		<nav class="colorlib-nav" role="navigation" style="background: #2d2f3f;">
			<div class="top-menu">
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-2">
							<div id="colorlib-logo"><a href="../../">Haitises Montaña Redonda</a></div>
						</div>
											...
											<div class="room-wrap">
												<div class="row">
													<div class="col-md-12 col-sm-12">
														<div class="desc">
															<h2>Description</h2>
															<p>Enjoy a great Ecological Adventure in the Dominican Republic, through the Coastal Plain of the East-Northeast region.</p>
															<p><a href="#formulariocompratour" class="btn btn-primary">BOOK NOW!</a></p>
															<p>Departing from your Hotels in modern and comfortable buses, by the Choral Highway, we arrive at Miches, a small town of Pescadores. We continue our trip until we reach the town of La Cañita in the middle of miches and Sabana de la Mar, where we will enjoy a light breakfast.</p>
															<p>We continue our journey to Sabana de la Mar to board the boat leaving Caño Hondo towards Los Haitises National Park, it is one of the 4 most important Cars Parks in the World, with a rich fauna and exuberant flora, with endemic species of the Zone.</p>
															<p>Once in the Park, we visited three Caverns, which have Petroglyphs and Carvings on the walls of Roca. There you can appreciate the art left by the Tainos, know their history, as well as see the species of Birds and Mammals that inhabit these Caverns. We will also visit several Mogotes or Atolls scattered in the Sea that surrounds the north of the Park, inhabited by dozens of species of birds.</p>
															<p>After the tour of the Park, we go back by boat to the Muelle de Canita, where the restaurant is located, there will be the Buffet Lunch.</p>
															<p>After lunch, we take the bus and go to Montaña Redonda, which we will climb to its top in the Safari Truck; it has a special location, being in the middle of two large lagoons (Laguna Limón & Laguna Redonda), to the east it has the Atlantic Ocean and to the west the Eastern Cordillera.</p>
															<p>Located between these points of interest, Montaña Redonda offers us the most spectacular panoramic view of the Dominican Republic. We can appreciate the beautiful landscape that surrounds it of both Lagunas, La Bahía and Peninsula de Samaná, from there you can take unique photos.</p>
															<p>Then we start the descent until we get to the bus, to go to their hotels.</p>
															<h3>INCLUDES:</h3>
															<p>
															...
															<p style="color: red;">
																<strong>
																	- OPERATION DAYS: TUESDAY & SATURDAYS ONLY<br>
																	- PICK-UP FROM HOTELS: FROM 6:00 TO 7:00AM (DEPENDING ON YOUR HOTEL LOCATION). <br>
					                ...
					                <div class="col-md-12">
					                  <div class="form-group">
					                    <div class="form-field">
					                     ...
					                     <select class="form-control" name="tourHotel1" id="tourHotel1">
					                ...
					                <div class="col-md-12">
					                  <div class="form-group">
					                    <div class="form-field">
					                     ...
					                     <select class="form-control" name="tourTurno" id="tourTurno">
					                     	<option selected>7:00AM</option>
					                     </select>
					                    </div>
					                  </div>
					                </div>
					                <div class="col-md-12">
					                  <div class="form-group">
					                    <div class="form-field">
					                      ...
					                      <input type="text" name="tourRecogidadelhotel" id="tourRecogidadelhotel" class="form-control" readonly value="6:00AM to 7:00AM">
					                    </div>
					                  </div>
					                </div>
					                <div class="col-md-12">
	...
	<script>
		$(document).ready(function(){
			$("#tourFecha").datepicker({ startDate: "+0d", daysOfWeekDisabled: [0,1,3,5,4] });
		});
		function calculartour(){
	    if (document.getElementById('tourHotel1').value != "") {
	      ...
	      document.getElementById('tournombre').value = 'Los Haitises Montana Redonda';
