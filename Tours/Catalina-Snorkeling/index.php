  ...
  <!-- Facebook and Twitter integration -->
		...
		<nav class="colorlib-nav" role="navigation" style="background: #2d2f3f;">
			<div class="top-menu">
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-2">
							<div id="colorlib-logo"><a href="../../">Catalina Island Snorkeling</a></div>
						</div>
				...
				<div class="row">
					<div class="col-md-12 animate-box">
						<div class="owl-carousel">
							...
							<div class="item">
								<div class="hotel-entry">
									<a href="#top" class="hotel-img" style="background-image: url(images/2.png);">
									</a>
								</div>
							</div>
							<div class="item">
											...
											<div class="room-wrap">
												<div class="row">
													<div class="col-md-12 col-sm-12">
														<div class="desc">
															<h2>Description</h2>
															<p>This great adventure begins by approaching the Catamaran in the Rio Salado of the City of La Romana, to make a spectacular trip to Catalina Island.</p>
															<p><a href="#formulariocompratour" class="btn btn-primary">BOOK NOW!</a></p>
															<p>Already in the elegant and cozy Catamaran, with music and lots of fun, the next stop: Catalina Island, also called the Jewel of the Caribbean.</p>
															<p>This small island of crystal clear waters, white sands and intense green vegetation, has the most impressive coral reef in the Dominican Republic and one of the most beautiful in the Caribbean. This Barrier Reef or Coral Wall (as many call it) is visited by thousands of tourists every year, to enjoy its charm and beauty. It has a great Fauna adorned by the colors of the different species of fish, as well as corals.</p>
															<p>On Catalina Island, you can enjoy a tour in the Banana, crystal clear waters, sunbathing, walking on its white and soft sand beaches. You will also enjoy a typical Dominican lunch, the Bar is open with Rom, Beer, Cuba Libre, Cola, Agua and of course the MAMAJUANA.</p>
															<h3>INCLUDES:</h3>
															<p>
																- Round trip transportation<br>
																- Lunch and open bar<br>
															</p>
															...
															<p style="color: red;">
																<strong>
																	- OPERATION DAYS: MONDAY, WEDNESDAY, THURSDAY, FRIDAY & SUNDAYS<br>
																	- PICK-UP FROM HOTELS: FROM 6:30 TO 7:15AM (DEPENDING ON YOUR HOTEL LOCATION). <br>
					                ...
					                <div class="col-md-12">
					                  <div class="form-group">
					                    <div class="form-field">
					                      ...
					                      <input type="text" name="tourRecogidadelhotel" id="tourRecogidadelhotel" class="form-control" readonly value="6:30AM to 7:15AM">
					                    </div>
					                  </div>
					                </div>
					                <div class="col-md-12">
	...
	<script>
		$(document).ready(function(){
			$("#tourFecha").datepicker({ startDate: "+0d", daysOfWeekDisabled: [2,6] });
		});
	    ...
	    if (document.getElementById('tourHotel1').value != "") {
	      ...
	      document.getElementById('tournombre').value = 'Catalina Island Snorkeling';
