  ...
  <!-- Facebook and Twitter integration -->
		...
		<nav class="colorlib-nav" role="navigation" style="background: #2d2f3f;">
			<div class="top-menu">
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-2">
							<div id="colorlib-logo"><a href="../../">Saona Island</a></div>
						</div>
											...
											<div class="room-wrap">
												<div class="row">
													<div class="col-md-12 col-sm-12">
														<div class="desc">
															<h2>Description</h2>
															<p>Experience the most popular and amazing sailing tour to the ever beautiful crystal clear, turquoise waters and white sand beaches of SAONA ISLAND.</p>
															<p><a href="#formulariocompratour" class="btn btn-primary">BOOK NOW!</a></p>
															<p>After a comfortable ride from your hotel/resort you will be sailing the shallow Caribbean waters by catamaran as you enjoy listening to music, dancing and being part of our entertainment team. They would make your day unforgettable! Relax and suntan on the net and be ready to pull out your camera to take beautiful pictures of the amazing landscape that slowly develops before your eyes as you approach land. Enjoy the crystalline waters or explore the tropical surrounds by walking the white sand beaches. On the way back, be ready to feel the adrenaline as we engage in a safe but thrilling speedboat competition to win the race to the “Natural Pool Area”. Get your star fish (Keep it just a few seconds out of the water) and take pictures of the most beautiful scenery the tour will offer.</p>
															<h3>INCLUDES:</h3>
															<p>
																- - Round trip transportation on air conditioned bus <br>
																- Professional guide<br>
																- Lunch and open bar <br>
																- Quick restroom and shopping stop before returning to hotel/resort
															</p>
															...
															<p style="color: red;">
																<strong>
																	...
																	- PICK-UP FROM HOTELS: FROM 6:40 TO 8:00AM (DEPENDING ON YOUR HOTEL LOCATION) <br>
					                ...
					                <div class="col-md-12">
					                  <div class="form-group">
					                    <div class="form-field">
					                      ...
					                      <input type="text" name="tourRecogidadelhotel" id="tourRecogidadelhotel" class="form-control" readonly value="6:40AM to 8:00AM">
					                    </div>
					                  </div>
					                </div>
					                <div class="col-md-12">
	...
	<script>
	    ...
	    if (document.getElementById('tourHotel1').value != "") {
	      ...
	      document.getElementById('tournombre').value = 'Saona Island';
