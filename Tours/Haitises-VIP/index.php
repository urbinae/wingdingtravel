  ...
  <!-- Facebook and Twitter integration -->
		...
		<nav class="colorlib-nav" role="navigation" style="background: #2d2f3f;">
			<div class="top-menu">
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-2">
							<div id="colorlib-logo"><a href="../../">Haitises VIP</a></div>
						</div>
				...
				<div class="row">
					<div class="col-md-12 animate-box">
						<div class="owl-carousel">
							...
							<div class="item">
								<div class="hotel-entry">
									<a href="#top" class="hotel-img" style="background-image: url(images/3.png);">
									</a>
								</div>
							</div>
						</div>
												...
												<div class="row">
													<div class="col-md-12 col-sm-12">
														<div class="desc">
															...
															<p>Los Haitises National Park has a humid tropical forest vegetation and has a great diversity of mammals and marine birds, including dolphins, manatees, sea turtles, gannets and frigates. Some of the caverns contain pictograms and petroglyphs of the first Americans called Taíno Indians.</p>
															<p>Arriving at Cano Hondo dock, coffee, juice, flavored waters and snacks are served. Speedboats that lead to a walk through canals and lagoons filled with an abundant jungle of mangroves to the spectacular landscape of the Bay of San Lorenzo.</p>
															<p>We stopped at the virgin beach of Punta Arena, in the shape of a half moon and full of palms. Take your welcome cocktail, a crazy coconut.</p>
															<p>The very calm waters are clear but transparent, full of stars of the sea.</p>
															<p>Crossing the peninsula with a few steps to the Bay of Samaná with an impressive panoramic view. Treat yourself to a swim in the calm waters, walk along the beach or just relax under the palm trees. A luxury lunch with fresh lobster and seafood are served in the form of barbecue directly on the beach.</p>
															<p>On board the Sir Francis Drake, a historic replica of an all-wood galleon, fully equipped for your comfort and convenience, we make a relaxing cruise for the entire bay.</p>
															<p>With wind in favor we can raise the sails. Observe the sea birds from the panoramic deck, appreciate the beautiful lush green coastline or simply relax on the sunny deck.</p>
															<p>Tropical drinks are served by our pirate crew.</p>
															<p>With some luck to date, very abundant in the area.</p>
															<p>We stop in baths in a ravine during the half hour, where you can observe swimming the abundant flora and fauna. Drinks to be served by our floating bar.</p>
															<p>Returning on board to be served champagne (dry sparkling wine).</p>
															<p>Everything you need for the best day of your vacation:</p>
															<h3>INCLUDES:</h3>
															<p>
															...
															<p style="color: red;">
																<strong>
																	...
																	- PICK-UP FROM HOTELS: FROM 6:00 TO 7:15AM (DEPENDING ON YOUR HOTEL LOCATION). <br>
					                ...
					                <div class="col-md-12">
					                  <div class="form-group">
					                    <div class="form-field">
					                      ...
					                      <input type="text" name="tourRecogidadelhotel" id="tourRecogidadelhotel" class="form-control" readonly value="6:00AM to 7:15AM">
					                    </div>
					                  </div>
					                </div>
					                <div class="col-md-12">
	...
	<script>
	    ...
	    if (document.getElementById('tourHotel1').value != "") {
	      ...
	      document.getElementById('tournombre').value = 'Los Haitises Exclusive VIP';
