  ...
  <!-- Facebook and Twitter integration -->
		...
		<nav class="colorlib-nav" role="navigation" style="background: #2d2f3f;">
			<div class="top-menu">
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-2">
							<div id="colorlib-logo"><a href="../../">Santo Domingo</a></div>
						</div>
											...
											<div class="room-wrap">
												<div class="row">
													<div class="col-md-12 col-sm-12">
														<div class="desc">
															<h2>Description</h2>
															<p>Over Five Centuries of History.</p>
															<p><a href="#formulariocompratour" class="btn btn-primary">BOOK NOW!</a></p>
															<p>Join us on day of interesting history, culture, sightseeing and much more.</p>
															<p>Explore the oldest city of the new world as we sightsee through its metropolitan area and colonial zone. Pass by the National Palace; visit the Alcazar of Diego Colón Museum, the first Cathedral of America and its monuments. Also shop in the famous “Las Damas” street in “El Conde” Pedestrian Street. In this Tour you will learn about our country and feel like you really visit the Dominican Republic.</p>
															<h3>INCLUDES:</h3>
															<p>
																- Round trip air conditioned transportation <br>
																- Professional guide<br>
																- Delicious Lunch
															</p>
															<h3>THINGS TO TAKE ON THE TOUR:</h3>
															<p>
																- - Bring bottles of water <br>
																- Sunblock <br>
																- Sunglasses <br>
															...
															<h3>NEVER FORGET:</h3>
															<p>
																- Wear light clothes for the colonial city walk and bring something to cover your <br>
																- Have breakfast before you leave on the tour. <br>
															...
															<p style="color: red;">
																<strong>
																	- OPERATION DAYS: TUESDAY & FRIDAYS ONLY<br>
																	- PICK-UP FROM HOTELS: FROM 6:00 TO 7:00 AM (DEPENDING ON YOUR HOTEL LOCATION) <br>
	...
	<script>
		$(document).ready(function(){
			$("#tourFecha").datepicker({ startDate: "+0d", daysOfWeekDisabled: [0,1,3,4,6] });
		});
	    ...
	    if (document.getElementById('tourHotel1').value != "") {
	      ...
	      document.getElementById('tournombre').value = 'Santo Domingo';
